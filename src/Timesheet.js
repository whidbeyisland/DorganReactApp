...
export default class Timesheet extends Component {
    ...
    constructor(props) {
        ...
        this.moveLeftOneWeek = this.moveLeftOneWeek.bind(this);
        this.moveRightOneWeek = this.moveRightOneWeek.bind(this);
    }

    updateDates() {
        // alert("got here");
        // this.monRef.state.day = "balsfisaf";
        // this.monRef.forceUpdate();

        // let stateCopy = JSON.parse(JSON.stringify(this.state));
        // stateCopy.day_mon = "aosfhofas";
    ...
    moveLeftOneWeek(e) {
        ...
        first.setDate(first.getDate() - 7); // First day is the day of the month - the day of the week
        ...
        let stateCopy = JSON.parse(JSON.stringify(this.state));
        stateCopy.day_mon = (first_1.getMonth() + 1) + "/" + (first_1.getDate());
        stateCopy.day_tue = (first_2.getMonth() + 1) + "/" + (first_2.getDate());
        stateCopy.day_wed = (first_3.getMonth() + 1) + "/" + (first_3.getDate());
        stateCopy.day_thu = (first_4.getMonth() + 1) + "/" + (first_4.getDate());
        stateCopy.day_fri = (first_5.getMonth() + 1) + "/" + (first_5.getDate());
        this.setState(stateCopy);

        this.monRef.current.changeDay((first_1.getMonth() + 1) + "/" + (first_1.getDate()));
        this.tueRef.current.changeDay((first_2.getMonth() + 1) + "/" + (first_2.getDate()));
        this.wedRef.current.changeDay((first_3.getMonth() + 1) + "/" + (first_3.getDate()));
        this.thuRef.current.changeDay((first_4.getMonth() + 1) + "/" + (first_4.getDate()));
        this.friRef.current.changeDay((first_5.getMonth() + 1) + "/" + (first_5.getDate()));
        ...
        // this.monRef.current.changeDay("blah");
        alert("got here");
    }
        ...
        return(
            <div className="timesheet">
              <Form onClick={this.updateTimeFunc}>
                  ...
                  <ArrowLeft style={{ float: 'left', width: '4%', margin: '0.5%', color: '#888888', height: '170px' }} onClick={this.moveLeftOneWeek} />
                  ...
                  <ArrowRight style={{ float: 'right', width: '4%', margin: '0.5%', color: '#888888', height: '170px' }} onClick={this.moveRightOneWeek} />
